...
const ALL_TIPS = [
  ...
  { title: 'Дыхание 4-7-8', description: 'Замедляет пульс и успокаивает', icon: '🧘' },
  ...
  { title: 'Спальня только для сна', description: 'Не работайте в кровати', icon: '🛌' },
  ...
  { title: 'Умеренная прогулка', description: '15–20 минут вечером', icon: '🚶' },
  ...
  { title: 'Комфортное бельё', description: 'Натуральные ткани улучшают терморегуляцию', icon: '🛏️' },
  ...
  { title: 'Физическая активность', description: 'Но не за 2 часа до сна', icon: '🏃' },
  { title: 'Дышите глубже', description: 'Активирует парасимпатическую систему', icon: '😮‍💨' },
  { title: 'Дневной свет утром', description: 'Помогает стабилизировать биоритмы', icon: '🪟' },
  ...
  { title: 'Не лежите долго без сна', description: 'Если не спится — встаньте, пройдитесь', icon: '🙅' },
  ...
  { title: 'Шум дождя', description: 'Монотонные звуки успокаивают', icon: '🎧' },
